...
#define APP_INITIALIZE_DESKTOP FUNCTION_NAME_EXPANDED(EXTENSION_NAME, AppInitialize_Desktop)
#define APP_FINALIZE_DESKTOP FUNCTION_NAME_EXPANDED(EXTENSION_NAME, AppFinalize_Desktop)
#define INITIALIZE_DESKTOP FUNCTION_NAME_EXPANDED(EXTENSION_NAME, Initialize_Desktop)
#define UPDATE_DESKTOP FUNCTION_NAME_EXPANDED(EXTENSION_NAME, Update_Desktop)
#define FINALIZE_DESKTOP FUNCTION_NAME_EXPANDED(EXTENSION_NAME, Finalize_Desktop)
